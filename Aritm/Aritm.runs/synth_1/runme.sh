...
HD_PWD='C:/Dokumenty/VUT FEKT/PLD/MPC_PLD/Aritm/Aritm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit4_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit4_add.tcl
