...
HD_PWD='C:/Dokumenty/VUT FEKT/PLD/MPC_PLD/Aritm/Aritm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit4_add.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit4_add.tcl -notrace
