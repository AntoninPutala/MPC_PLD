...
architecture Behavioral of serial_fsm is

    TYPE t_state IS (ST_IDLE, ST_LOAD, ST_WAIT_EN, ST_WRITE);
    ...
    SIGNAL sig_data_in         : STD_LOGIC_VECTOR (31 downto 0) := (others => '0');
    SIGNAL new_sig_data_in     : STD_LOGIC_VECTOR (31 downto 0);
...
BEGIN
    ...
    IF (pres_st = ST_WRITE) THEN
        sig_tx_data_out <= sig_data_in(31 - to_integer(sig_count(4 downto 0)));
    END IF;
END PROCESS;
...
BEGIN
    ...
    IF ((pres_st = ST_WRITE) and (sig_count = "11111")) THEN
        sig_count_end <= '1';
    END IF;
END PROCESS;
